                    ...
                    <form action="{{ route('joboportunity.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('hours_validated') is-invalid @enderror" id="hours_validated" name="hours_validated" value="{{ old('hours_validated') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('number_applicants') is-invalid @enderror" id="number_applicants" name="number_applicants" value="{{ old('number_applicants') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('number_vacancies') is-invalid @enderror" id="number_vacancies" name="number_vacancies" value="{{ old('number_vacancies') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('requirements') is-invalid @enderror" id="requirements" name="requirements" value="{{ old('requirements') }}" required>
                                @error('requirements')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
