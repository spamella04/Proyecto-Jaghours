...
<style>
    .job-card-avatar {
        ...
        height: 60px;
        border-radius: 50%;
        background-color: #219EBC !important; /* Aseguramos que el color se aplique usando !important */
        color: white; /* Color de la letra */
        font-size: 26px; /* Ajusta el tamaño de la inicial */
        font-weight: bold; /* Negrita para la letra */
        text-align: center;
    ...
    .btn-custom {
        ...
        color: white;
        border-color: #219EBC; /* También cambia el borde */
    }

    .btn-custom:hover {
        background-color: #1B88A7; /* Color más oscuro al pasar el mouse */
        border-color: #1B88A7;
    }
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="job-card shadow-lg p-3 bg-white rounded d-flex flex-column h-100">
                            <div class="job-card-header d-flex align-items-center">
                                ...
                                <div class="job-card-avatar d-flex justify-content-center align-items-center">
